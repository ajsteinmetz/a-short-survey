...
near chemical equilibrium, since the decay rate is compensated by the production rate, and within $100$ as, the chemical equilibrium yield is attained. We apply the same method in the early Universe and show that $\pi^0$ is in chemical equilibrium with photons at all temperatures of interest \cite{Kuznetsova:2009xh}
%~~Figure~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\begin{figure}[h]
