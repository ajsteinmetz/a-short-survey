...
\noindent This survey of the early Universe begins, with elementary particles in their known form today, with quark-gluon plasma (QGP) at a temperature of $130\GeV$. This survey then ends at a temperature of $20\keV$ with the electron-positron epoch which was the final phase of the Universe to contain significant quantities of antimatter. The defines the short 1/2 hour timespan of the Universe. {\xred Cleanup!} This work presumes that the Universe is homogeneous and that in our casual domain, the Universe's baryon content is matter dominated. While the literature contains many comprehensive reviews of observational cosmology \cite{Davis:1985rj,Springel:2005nw,Arbey:2021gdg}, the recombination period \cite{Planck:2018vyg,Planck:2018nkj}, BBN \cite{Steigman:2007xt,Cyburt:2015mya,Pitrou:2018cgg}, baryon asymmetry \cite{Canetti:2012zc,ParticleDataGroup:2022pth}, and inflationary epochs \cite{Baumann:2009ds,Allahverdi:2020bys}, we aim to fill the niche of a general overview of the antimatter content of the universe with details absent from more general texts like Kolb and Turner \cite{kolb1981early}. {\xred We pick up where K and T left the topic and coherently connect the differing plasma providing the background explored in the more specific periods found in the literature reviews of ... There is much work on topics prior to 130 GeV on the inflationary universe outside which is outside the purview of our work.}
