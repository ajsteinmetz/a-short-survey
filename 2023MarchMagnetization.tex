...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Electron-positron plasma}
...
&+\ln\left(1+e^{-\beta(E_{n}^++\eta_{e}{\color{red}-}\eta_s)}\right)+\ln\left(1+e^{-\beta(E_{n}^-+\eta_{e}{\color{red}+}\eta_s)}\right)\bigg],
\end{align}
...
\end{align}
where the $\pm$ script refers to spin aligned and anti-aligned eigenvalues. In following we considering the case $\eta_s/T\ll1$ for the first approximation and Boltzmann approximation for nonrelativistic electrons and positrons. Using the Euler-Maclaurin formula to replace the sum over Landau levels with an integration yielding
\begin{align}
...
While this would require further derivation to demonstrate explicitly, the benefit of the Euler-Maclaurin approach is if the error contribution remains finite or bound for the magnetized partition function, then a correspondence between the free Fermi partition function (with noticeably modified magnetic-mass $\tilde{m}_{\pm}$) and the magnetized Fermi partition function can be established. The mismatch between the summation and integral in the Euler-Maclaurin formula would then encapsulate the immediate magnetic response and deviation from the free particle phase space.
 ...
 Considering the error remainder $R$ is small and can be neglected. Here we will not limit ourselves to $g=2$ and allow the g-factor to be arbitrary in value. In this case, we have
\begin{align}
  \label{lnZ}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Cheng Tao: I hide the following section, but feel free to edit them if you think we should include some details.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Neutrino freezeout in early universe}
...
\section{energy density ratio between electron/positron and baryons}
{\color{blue} Cheng Tao: I am not sure do we need to include this section in this paper, I just include here just in case if we need any ingredients for Introduction} 
...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Cosmological strangeness abundance}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\section{The pion abundance in the early universe}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\section{The muon abundance in the early univese}
